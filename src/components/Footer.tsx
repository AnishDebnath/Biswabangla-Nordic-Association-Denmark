  ...
  return (
    <footer className="bg-[#171313] text-[#FFF9EF] relative overflow-hidden pt-12 sm:pt-16 md:pt-20 pb-8 sm:pb-12 md:pb-16 px-4 md:px-8 lg:px-12 xl:px-20 border-t border-[#D4AF62]/40">
      ...
      <div className="max-w-4xl xl:max-w-5xl mx-auto text-center flex flex-col items-center justify-center relative z-10 w-full">
        ...
        <span className="block text-4xl sm:text-5xl md:text-6xl font-['Noto_Serif_Bengali'] font-bold text-transparent bg-clip-text bg-gradient-to-r from-[#FFF9EF] via-[#D4AF62] to-[#FFF9EF] mb-2 md:mb-3">
          শুভ শারদীয়া
        </span>

        {/* Association Branding */}
        <h3 className="text-xs md:text-sm uppercase tracking-[0.3em] font-semibold text-[#D4AF62] mb-1 md:mb-1.5">
          {eventConfig.organization.name}
        </h3>

        <p className="font-serif text-lg sm:text-xl md:text-2xl text-[#FFF9EF]/90 font-medium mb-1 md:mb-1.5">
          5th Annual Durga Puja Celebration • 2026
        </p>

        <p className="text-xs md:text-sm font-serif italic text-[#D4AF62]/80 mb-4 sm:mb-6">
          Denmark
        </p>
        ...
        {/* Motto */}
        <p className="text-xs sm:text-sm md:text-base font-sans text-[#FFF9EF]/75 font-light tracking-wide max-w-prose md:max-w-xl mx-auto mb-6 sm:mb-8 md:mb-10">
          {eventConfig.organization.tagline}
        </p>

        {/* Quick Links & Socials */}
        <div className="flex flex-wrap items-center justify-center gap-2.5 sm:gap-4 md:gap-6 text-xs md:text-sm uppercase tracking-wider font-medium text-[#FFF9EF]/80 mb-8 sm:mb-10 md:mb-12 max-w-2xl mx-auto">
          <a
        ...
        {/* Copyright */}
        <div className="pt-5 sm:pt-6 border-t border-[#FFF9EF]/10 text-[11px] sm:text-xs text-[#FFF9EF]/50 font-sans">
