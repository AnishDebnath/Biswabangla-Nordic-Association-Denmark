...
export const PujaInfo: React.FC = () => {
  ...
  return (
    ...
    >
      {/* Section Header */}
      <div className="text-center flex flex-col items-center justify-center max-w-2xl lg:max-w-3xl mx-auto mb-8 sm:mb-10 md:mb-12 w-full">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3.5 sm:gap-4 md:gap-5 lg:gap-3.5 xl:gap-6">
        {infoCards.map((card) => (
          <div
            key={card.id}
            id={card.id}
            className="bg-[#FFF9EF]/95 border border-[#D4AF62]/50 rounded-2xl md:rounded-3xl p-4 sm:p-5 lg:p-3.5 xl:p-6 shadow-md hover:shadow-lg hover:border-[#B8863B] transition-all duration-300 flex flex-col justify-between group"
          >
            <div>
              {/* Top icon and tag */}
