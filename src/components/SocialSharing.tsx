  ...
  return (
    ...
    >
      <div className="max-w-4xl xl:max-w-5xl mx-auto text-center flex flex-col items-center justify-center relative z-10 w-full">
        ...
        {copied && (
          <StaggerItem variant="fadeUp" className="mt-4 md:mt-6 inline-flex items-center gap-2 px-4 md:px-5 py-1.5 md:py-2 rounded-full bg-[#D4AF62] text-[#171313] text-xs md:text-sm font-bold shadow-md">
